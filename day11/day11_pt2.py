...
with open('input.txt') as f:
    monkeys = []
    # For modular arithmetic, eventually we'll just need to keep our
    # worry levels modulo the product of all our test divisors
    divisor = 1
    # make monkeys
    for line in f:
...
# 10000 rounds of throwing
for r in range(10000):
    for index, monkey in enumerate(monkeys):
        while monkey.has_items():
            worry = monkey.inspect(divisor)
